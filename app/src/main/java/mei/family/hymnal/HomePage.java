...
public class HomePage extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		ActionBarDrawerToggle _toggle = new ActionBarDrawerToggle(HomePage.this, _drawer, _toolbar, R.string.app_name, R.string.app_name);
		...
		imageview2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				go.setClass(getApplicationContext(), SearchPage.class);
				startActivity(go);
			}
		});
	...
	private void initializeLogic() {
		if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {
			final Window window = HomePage.this.getWindow();
		...
		_setFullscreen();
		Window w = HomePage.this.getWindow();w.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);w.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS); w.setStatusBarColor(Color.parseColor("#3F51B5"));
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			linear1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					...
					go.setClass(getApplicationContext(), SongPage.class);
					startActivity(go);
				}
			});
